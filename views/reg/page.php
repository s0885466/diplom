        ...
        <div class="col-md-8 bg-light rounded">
            ...
            <form method="post" action="" class="m-4 col-6">
                <? if($result!=false):?>
                    ...
                    <div class="alert alert-primary" role="alert">Письмо с паролем отправлено на ваш почтовый адрес</div>
                <? else: ?>
                <div>
                    <? if($errors!=false):?>
                ...
                <div class="form-group">
                    ...
                    <input name="name" value="<?=$name?>" type="text" class="form-control" id="name" placeholder="Введите имя">
                    <small class="form-text text-muted">Имя должно быть не менее 5 символов</small>
                </div>
                <div class="form-group">
