                            ...
                            <div class="card mb-4 shadow-sm">
                                <div class="m-3">
                                    ...
                                    <form>
                                        ...
                                        <hr>
                                        <div class="form-group row">
                                            <label for="length" class="col-sm-4 col-form-label">Колич:</label>
                                            <span class="col-sm-6">
                                                <input type="number" step="0.1" class="form-control" id="amount" placeholder="Количество">
                                            </span>
                                            <span class="pl-3">кг</span>
                                        </div>
...
<script src="/build/js/electrode/page.js"></script>
</body>
</html>